				...
				<div className='flex flex-wrap justify-center gap-[4.5rem] mx-0 my-[4%]'>
					{data.slice(0, visibleItems).map((item) => (
						<div
							...
							key={item.text}
						>
							<div className='w-[30rem] h-[30rem] flex flex-col justify-center items-center gap-6 opacity-0 hover:bg-[#515155cf] hover:opacity-100 hover:transition-all hover:duration-[1s] hover:ease-[ease] hover:delay-[0s]'>
